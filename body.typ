...
#h(2em) Проект нацелен на разработку сервиса, который позволит пользователю управлять своей медиатекой на домашнем сервере (в облаке), а также прослушивать музыкальные произведения (файлы) с разных устройств (мобильного устройства и компьютера).
...
операционной системой iOS и доступ в интернет.
...
#h(4em) - Возможность указать название композиции.\
#h(4em) - Возможность указать исполнителя.\
#h(4em) - Возможность указать альбом.\
...
#h(2em) 2. Внизу каждой страницы расположена панель, на которой расположены кнопки для перехода в разделы "Главная", "Моя музыка", "Аккаунт"

#h(2em) 3. Окно авторизации и входа\
#h(4em) 3.1. Содержит поле для ввода почты\
#h(4em) 3.2. Содержит поле для ввода пароля\
#h(4em) 3.3. Снизу расположена кнопка "Войти"\
#h(4em) 3.4. Ниже кнопка "Забыли пароль?". При переходе на нее:\
#h(6em) 3.4.1. Поле для ввода почты\
#h(6em) 3.4.2. Кнопка "Восстановить пароль"\
#h(4em) 3.5. Внизу экрана расположена кнопка "Зарегистрироваться". При переходе на нее:\
#h(6em) 3.4.1. Поле для ввода почты\
#h(6em) 3.4.2. Поле для ввода пароля\
#h(6em) 3.4.3. Внизу расположена кнопка "Зарегистрироваться"\

#h(2em) 4. Раздел "Главная"\
#h(4em) 4.1. Сверху расположено название приложения\
#h(4em) 4.2. В верхней части расположена кнопка воспроизведения композиций с цветовой визуализацией\
#h(4em) 4.3. Ниже расположена кнопка "Добавить музыку"\
#h(4em) 4.4. Ниже расположена кнопка "Создать плейлист"\
#h(4em) 4.5. Ниже расположены списки композиций, альбомов, артистов, которые есть в музыклаьной библиотеке пользователя, а также кнопки для перехода ко всем композициям, альбомам и артистам пользователя.

#h(2em) 5. Раздел "Моя музыка"\
#h(4em) 5.1. Вверху расположена поисковая строка.\
#h(4em) 5.2. Слева расположена кнопка для фильтра.\
#h(4em) 5.3. Рядом с ней расположена кнопка сортировки\
#h(4em) 5.2. Ниже расположены кнопки для выбора группы: композиции, альбомы, плейлисты, исполнители.\
#h(4em) 5.3. На больше части экрана расположен список всех композиций, альбомов, плейлистов, исполнителей в зависимости от текущего выбора группы.

#h(2em) 6. Раздел "Аккаунт"\
#h(4em) 6.1. В правом верхнем углу расположена кнопка для перехода в раздел "Настройки"\
#h(4em) 6.2. Слева вверху расположено фото аккаунта, правее которого написано имя пользователя. Ниже дана информация о количестве композиций\
#h(4em) 6.3. В центре расположен топ-5 наиболее часто проигрываемые композиции за последние 30 дней. Ниже расположено топ-3 исполнителя, чьи композиции воспроизводились наиболее часто за последние 30 дней. При нажатии на заголовок "Топ треков" открывается раздел со статистикой композиций (название, исполнитель, длительность композиции), аналогично, при нажатии на "Топ артистов" открывается раздел со статистикой исполнителей.\
...
#h(2em) 8. Экран воспроизведения композиций\
#h(4em) 8.1. Внизу расположены кнопки "Предыдущий трек", "Остановить/продолжить трек", "Следующий трек"\
#h(4em) 8.2. Выше кнопок расположена строка, отображающая на каком моменте проигрывается композиция\
#h(4em) 8.3. Большую часть экрана занимает обложка композиции\
#h(4em) 8.4. Между обложкой и строкой расположено название трека и имя исполнителя\
#h(4em) 8.5. Рядом есть кнопки для перемешивания следующих треков и повторного воспроизведения текущей композиции

#h(2em) 9. Раздел "Исполнитель"\
#h(4em) 9.1. В верхней части экрана расположено фото исполнителя, ниже имя исполнителя и информаци о количестве его композиций\
#h(4em) 9.2. Ниже идут композиции исполнителя и его альбомы\
#h(4em) 9.3. Справа вверху расположена кнопка для редактирования исполнителя: смена имени, фото, добавление, удаление композиции, альбома.
...
#h(2em) Программа будет востребована среди людей, которые хотят хранить свою музыкальную бибилотеку независимо от стриминговой платформы и иметь постоянный доступ к ней.

== Экономические преимущества разработки по сравнению с отечественными и зарубежными аналогами

#h(2em) Для оценки преимуществ проекта было проведено сравнение функциональных характеристик с аналогами разрабатываемого приложения. Рассмотрены только беслпатные версии аналогов без подписки. Данные сравнения отображены в таблице 1.
...
#figure(
    table(
        ...
        [Загрузка материалов курсового проекта в ЛМС, дисциплина "Курсовой проект, 2 курс, ПИ"], alex, [],
